...
Applies strict discrete quarter filtering to prevent Q4 restatement noise from distorting the R_t metric.
"""
...
# IMPORTANT: Update this to your institutional or personal email as required by SEC API guidelines
SEC_USER_AGENT = "Independent Reseaecher dramainmylife@gmail.com"
...
def fetch_sec_metric(cik: str, metric_name: str, fallback_chain: list) -> list:
    ...
    try:
        ...
        if e.response.status_code == 429:
            logger.warning(f"Rate limited on CIK {cik}. Waiting 10s...")
            time.sleep(10)
...
def crawl_sec_data():
    """Main crawler function reading from YAML config."""
